...
const serverEnvSchema = z
  .object({
    ...
    AWU_AUTOMATION_SECRET: z.string().optional(),
    N8N_ALERT_WEBHOOK_SECRET: z.string().optional(),
    ...
    WHATSAPP_DELIVERY_FAILURE_THRESHOLD: z.coerce.number().int().positive().default(3),
    WHATSAPP_DELIVERY_FAILURE_WINDOW_MS: z.coerce.number().int().positive().default(600_000),
    WHATSAPP_DELIVERY_CIRCUIT_OPEN_MS: z.coerce.number().int().positive().default(1_800_000),
...
export const serverEnv = serverEnvSchema.parse({
  ...
  AWU_AUTOMATION_SECRET: process.env.AWU_AUTOMATION_SECRET,
  N8N_ALERT_WEBHOOK_SECRET: process.env.N8N_ALERT_WEBHOOK_SECRET,
  ...
  WHATSAPP_DELIVERY_FAILURE_THRESHOLD: process.env.WHATSAPP_DELIVERY_FAILURE_THRESHOLD,
  WHATSAPP_DELIVERY_FAILURE_WINDOW_MS: process.env.WHATSAPP_DELIVERY_FAILURE_WINDOW_MS,
  WHATSAPP_DELIVERY_CIRCUIT_OPEN_MS: process.env.WHATSAPP_DELIVERY_CIRCUIT_OPEN_MS,
