...
const contextualAliases: Record<string, string[]> = {
  ...
  refrigerante: ["supermercado", "mercado", "compras casa"],
  coca: ["supermercado", "mercado", "compras casa"],
  guarana: ["supermercado", "mercado", "compras casa"],
  fanta: ["supermercado", "mercado", "compras casa"],
  sprite: ["supermercado", "mercado", "compras casa"],
  suco: ["supermercado", "mercado", "compras casa"],
